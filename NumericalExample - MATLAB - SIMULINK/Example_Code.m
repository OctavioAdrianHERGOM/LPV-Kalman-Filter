...
%EXAMPLE
%addpath(genpath('C:\Users\adria\Desktop\YALMIP-master'));
...
%addpath(genpath('C:\Users\adria\Desktop\SDPT3-4.0'));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% HERE IS PRESENTED AN ALTERNATIVE WAY TO COMPUTE THE VERTEX SYSTEMS
% BASED ON A LPV REPRESENTATION IN CONTINOUS TIME
% HOWEVER, ENSURE TO GET THE EXACT NONLINEAR BEHAVIOR UNDER THE SELECTED
% BOUNDS
...
% The data correspond to the original simulation performed using the proposed parameters. 
...
Datos = importdata('---\Input_Output.mat');

%% EXAMPLE
%Datos = importdata('C:\Users\adria\Desktop\Input_Output.mat');
...
%They must be selected inside the modeling region
x1 = 0;
x2= 0.1;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            %% System Output (estimated output without correction)
            dx1 = System_dx(1);
            dx2 = System_dx(2);
